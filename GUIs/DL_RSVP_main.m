...
% Initialize reshape size
handles.channel_num = 68;
handles.time_sample = 128;
...
handles.synthesised_target = double(reshape(synthesised_target, [handles.channel_num, handles.time_sample]));
handles.synthesised_nontarget = double(reshape(synthesised_nontarget, [handles.channel_num, handles.time_sample]));
...
if handles.tablebusy == 0
    ...
    handles.curr_weights = double(reshape(handles.DL_saved_res.Weights(hidden_position, :), [handles.channel_num, handles.time_sample]));
